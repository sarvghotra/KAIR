...
class DatasetBlindSRLRHR(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        i = 0
        for data_name, data_name_lr, data_size, d in zip(opt['dataroot_H'], opt['dataroot_L'], opt['data_sizes'], train_img_files):
            max_imgs = data_size
            ...
            print("=====================\n{}\n{}\n{}\n{}\n{}\n=========================".format(data_name, data_name_lr, data_size, self.paths_H[-1], self.paths_L[-1]))
